...
let StorePageClass = (function(){
    ...
    StorePageClass.prototype.addDrmWarnings = function() {
        ...
        if (drm) {
            ...
            if (node) {
                node.insertAdjacentHTML("afterend", '<div class="game_area_already_owned es_drm_warning"><span>' + warnString + '</span></div>');
            } else {
                document.querySelector("#game_area_purchase").insertAdjacentHTML("afterbegin", '<div class="es_drm_warning"><span>' + warnString + '</span></div>');
            }
        }
    };
