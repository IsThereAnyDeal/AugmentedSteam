        ...
        new MutationObserver(mutations => {
            ...
            for (const mutation of mutations) {
                ...
                for (const node of mutation.addedNodes) {
                    ...
                    if (yourItems > 0) {
                        const text = (yourItems === 1 ? Localization.str.tradeoffer.num_item : Localization.str.tradeoffer.num_items);
                    ...
                    if (theirItems > 0) {
                        const text = (theirItems === 1 ? Localization.str.tradeoffer.num_item : Localization.str.tradeoffer.num_items);
